    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fuwutupian" label="服务图片" prop="fuwutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fuwutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="准备材料" prop="zhunbeicailiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="准备材料"
                  v-model="ruleForm.zhunbeicailiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhunbeicailiao" label="准备材料" prop="zhunbeicailiao">
                    <span>{{ruleForm.zhunbeicailiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fuwuxiangqing = this.ruleForm.fuwuxiangqing.replace(reg,'../../../ssm626uh/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='minjing'" class="input-group">
			   <div class="label">警号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jinghao" class="input" type="text" placeholder="警号">
			   </div>
			 </div> -->
			<el-form-item label="警号" class="input" v-if="tableName=='minjing'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='minjing'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='minjing'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="警察姓名" class="input" v-if="tableName=='minjing'">
			  <el-input v-model="ruleForm.jingchaxingming" autocomplete="off" placeholder="警察姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='minjing'" class="input-group">
			   <div class="label">身份证</div>
			   <div class="input-container">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='minjing'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
			<!-- <div v-if="tableName=='minjing'" class="input-group">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='minjing'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `minjing` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.jingchaxingming) && `minjing` == this.tableName){
        this.$message.error(`警察姓名不能为空`);
        return
      }
